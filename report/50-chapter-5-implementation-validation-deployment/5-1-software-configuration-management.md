...
| `nexa-webapp` | Frontend Web Application | `v2.0.0` | Web Application frontend con flujos operativos, navegación por roles, Fake API, integración progresiva con backend y releases frontend. | `main` | [Repositorio `nexa-webapp`](https://github.com/upc-pre-202610-1asi0730-12242-king/nexa-webapp) |
