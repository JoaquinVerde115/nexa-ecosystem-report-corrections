...
SOURCES=(
  ...
  90-conclusions.md
  99-bibliography.md
  annexes/annex-a-annexes.md
  annexes/annex-b-video-evidence.md
  annexes/annex-c-validation-evidence.md
  annexes/annex-d-github-repository-evidence.md
  annexes/annex-e-deployment-and-services-evidence.md
  annexes/annex-f-av2-pending-controlled-evidence.md
)
